            ...
            <div className={styles.content}>
                <div className={styles.text}>
                    ...
                    <p id={`${isDark ? "" : "black-txt"}`}>
                        Hi there. My name is Daniel Eta, and I tend to make a lot of software. Beyond my endless desire to <Link href="/work">create</Link> systems that solve contextual problems, I love to <Link href="/articles">write</Link>. A lot. I have a pretty simple markdown blog embedded into this this site that I would love you to checkout whilst you are here. I’ve built it to house the fragmented thoughts and processes that pop up in my head all day. It is mostly software related content, but if you look hard enough you would find anything ranging from philosophy to even data science.
                            <br />
                            <br />
